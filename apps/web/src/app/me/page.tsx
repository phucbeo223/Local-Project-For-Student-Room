      ...
      <main className="mx-auto max-w-[1160px] px-5 py-10 sm:px-10">
        ...
        <div className="grid gap-6 lg:grid-cols-[360px_minmax(0,1fr)]">
          ...
          <section className="grid gap-4 sm:grid-cols-2">
            <Link href="/favorites" className="group rounded-2xl border border-line bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"><span className="grid h-11 w-11 place-items-center rounded-xl bg-rose-50 text-xl text-rose-700">♥</span><h2 className="mt-4 text-lg font-extrabold text-ink">Phòng yêu thích</h2><p className="mt-2 text-sm leading-6 text-ink-muted">Xem lại các phòng đã lưu và dùng chúng để cá nhân hóa đề xuất.</p></Link>
            <Link href="/saved-searches" className="group rounded-2xl border border-line bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"><span className="grid h-11 w-11 place-items-center rounded-xl bg-cyan-50 text-xl text-cyan-700">⌕</span><h2 className="mt-4 text-lg font-extrabold text-ink">Tìm kiếm đã lưu</h2><p className="mt-2 text-sm leading-6 text-ink-muted">Quản lý tiêu chí và bật thông báo khi có phòng phù hợp.</p></Link>
            <Link href="/notifications" className="group rounded-2xl border border-line bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"><span className="grid h-11 w-11 place-items-center rounded-xl bg-amber-50 text-xl text-amber-700">●</span><h2 className="mt-4 text-lg font-extrabold text-ink">Thông báo</h2><p className="mt-2 text-sm leading-6 text-ink-muted">Kiểm tra các phòng mới khớp với tìm kiếm đã lưu.</p></Link>
            <Link href="/recommendations" className="group rounded-2xl border border-line bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"><span className="grid h-11 w-11 place-items-center rounded-xl bg-violet-50 text-xl text-violet-700">✦</span><h2 className="mt-4 text-lg font-extrabold text-ink">Dành cho bạn</h2><p className="mt-2 text-sm leading-6 text-ink-muted">Gợi ý có giải thích dựa trên các tương tác gần đây.</p></Link>
